 ...
 * signing in and starting a new company are the same request, the only
 * difference is what happens after (see app/auth/callback/route.ts, which
 * decides "existing profile" vs "pending invite" vs "new company" once the
 * link is clicked, not this component).
 */
export function EmailSignIn({
  ...
  /** Where /auth/callback should send them once signed in. */
  next: string;
  heading: string;
  reason: string;
}) {
